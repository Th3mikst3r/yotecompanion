...
public class SettingsActivity extends AppCompatActivity {
    ...
    private Button btnChangeEmail, btnChangePassword, btnSendResetEmail, btnRemoveUser,
            changeEmail, changePassword, sendEmail, remove, signOut, navBtn, btnChangeUserInfo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnChangeUserInfo = (Button) findViewById(R.id.change_user_info_button);
...
/*
        btnChangeUserInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SettingsActivity.this, Add_UserInfo.class);
